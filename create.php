...
<title>发布新职位-赚了吗-大学生求职就业网</title>
   ...
   <div class="f24">123456789</div>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                      <form action="comcreate.php" method="post" id="jobForm">
                          ...
                          <table class="btm">
                            ...
                            <textarea name="positionDetail" id="positionDetail" ></textarea>         	
                                ...
                                <tr>
                                	<td><span class="redstar">*</span></td>
                                	<td>工作地址</td>
                                	<td><input type="hidden" value="" name="positionLng" id="lng">
                            			<input type="hidden" value="" name="positionLat" id="lat">
                                        <div class="work_place f14">                            <input type="text" placeholder="请输入详细的工作地址" value="" name="positionAddress" class="input_520" id="positionAddress"></div>
                                    </td>
                                </tr>
                            </tbody></table>
                            <table>
                            	<tbody><tr>
                                	<td width="23"><span class="redstar">*</span></td>
                                	<td colspan="2">
                                   	接收简历的邮箱地址</td><td width="437"><input type="text" value="" id="forwardEmail" name="forwardEmail">
</td>
                                </tr>
                                <tr>
                                	<td width="23"></td>
                                ...
                                <tr>
                                	<td width="23"></td>
                                	<td colspan="2" align="center"><input type="submit" value="发布"  class="btn_32"></td>
                                </tr>
                       	  </tbody></table>
                        </form>
                    </dd>
