...
if (form.newpassword.value!=form.comfirmpassword.value)    
{    
alert("两次输入的密码不同！");    
return false;    
}    
...
<dd style="display: none;"><a href="positions.php">我发布的职位</a></dd>
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
                <dd>&nbsp;</dd>
        <dd><a class="hover" href="updatePwd.php">修改密码</a></dd>
            </dl>
</div>
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
        <dl class="c_section">
            ...
            <dd>
            	            	<form action="upcode.php" method="post" onSubmit="return isValid(this);">
