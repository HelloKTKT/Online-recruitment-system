...
include('conn.php');
if(isset($_GET["cid"])){
$sql="select * from com where cid='{$_GET["cid"]}'";
}
      ...
      <div class="clearfix">
      	...
      	<!--[if IE 7]> <br /> <![endif]-->
						...
						<dl id="noJobs" class="c_section">
		                    ...
		                    <dd> <ul class="hot_pos reset">
	                    		                    			               <?php 
include('conn.php');
$sql2="select * from job where  cid='{$_GET["cid"]}' ORDER BY jid DESC";
...
<input type="hidden" value="<?php echo $cfield;?>" id="companySize" name="cfield">
  	...
  	<li>安全</li>	<li>运动体育</li>	<li>媒体</li>	<li>营销</li>	<li>云计算/大数据</li>	<li>移动广告</li>                                                                                                                                                                        
		                        ...
		                        <tr>
		                            <td>规模</td>
		                            <td>
		                            	<input type="hidden" value="<?php echo $csize;?>" id="companySize" name="csize">
		                            	<input type="button" value="<?php echo $csize;?>" id="select_sca" class="select_tags">
		                                <div class="selectBox dn" id="box_sca" style="display: none;">
		                                    <ul class="reset">
		                                    			                                    						                            			<li>少于15人</li>
				                            				                                        		                                    						                            			<li>15-50人</li>
