...
$sql="select * from orders where cid='{$_COOKIE['id']}' and ostate='通知面试' ";
...
while
	...
	$jname=$row3[3];
			                                ...
			                                <div class="resumeShow">
			                                    ...
			                                    <div class="links">
												 <a data-deliverid="1686182" data-name="jason" data-positionid="149594" data-email="888888888@qq.com" class="resume_notice" href="dealresumes.php?deal=pass&oid='.$oid.'">通过面试</a>
