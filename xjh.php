...
<table width="1001" id="gg"><tr><th width="54" >城市</th><th width="141">举办日期</th><th width="121">具体时间</th><th width="177">公司</th><th width="173">学校</th><th width="240">具体地点</th><th width="63">查看</th></tr><?php
include('conn.php');
$sql="select * from meeting  ORDER BY mid DESC ";
...
while
 ...
 echo'<tr ><td width="54">'.$mcity.'</td><td width="141">'.$mday.'</td><td width="121">'.$mtime.'</td><td width="177">'.$mcom.'</td><td width="173">'.$mschool.'</td><td width="240">'.$maddress.'</td><td width="63"><a href="xjhxx.php?mid='.$mid.'">查看<a></td></tr>';};?></table>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</form>
...
$(function(){
	...
	<div id="footer">
		<div class="wrapper">
		    ...
		    <a target="_blank" href="http://www.lagou.com/af/zhaopin.html">互联网公司导航</a><a rel="nofollow" href="javascript:void(0)" class="footer_qr"><i></i></a>
